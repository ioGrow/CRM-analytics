...
DIR_LIB = os.path.join(DIR_APP, 'lib')
DIR_LIBX = os.path.join(DIR_APP, 'libx')
...
REQUIREMENTS_URL = 'https://github.com/ioGrow/CRM-analytics'
...
def is_guard_newer(guard, watched):
...
def check_if_pip_should_run():
    return not is_guard_newer(FILE_PIP_GUARD, FILE_REQUIREMENTS)
